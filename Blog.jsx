...
export default function Blog() {
  return (
   <>
     <div className="hero-wrap hero-bread" style={{backgroundImage: "url('assets/images/p20.jpg')"}}>
      <div className="container">
        <div className="row no-gutters slider-text align-items-center justify-content-center">
          <div className="col-md-9  text-center">
          	<p className="breadcrumbs"><span className="mr-2"><Link to="index.html">Home</Link></span> <span>Blog</span></p>
        ...
        <div className="row">
          <div className="col-lg-8 order-lg-last ">
		            ...
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <Link to="blog-single.html" className="block-20" style={{backgroundImage: "url('assets/images/image_1.jpg')"}}>
		              </Link>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><Link to="#">April 9, 2019</Link></div>
		                ...
		                <p><Link to="blog-single.html" className="btn btn-primary py-2 px-3">Read more</Link></p>
		              </div>
		            </div>
		          </div>
		          <div className="col-md-12 d-flex ">
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <Link to="blog-single.html" className="block-20" style={{backgroundImage: "url('assets/images/image_2.jpg')"}}>
		              </Link>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><Link to="#">April 9, 2019</Link></div>
		          ...
		          <div className="col-md-12 d-flex ">
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <Link to="blog-single.html" className="block-20" style={{backgroundImage: "url('assets/images/image_3.jpg')"}}>
		              </Link>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><Link to="#">April 9, 2019</Link></div>
		          ...
		          <div className="col-md-12 d-flex ">
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <Link to="blog-single.html" className="block-20" style={{backgroundImage: "url('assets/images/image_5.jpg')"}}>
		              </Link>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><Link to="#">April 9, 2019</Link></div>
		          ...
		          <div className="col-md-12 d-flex ">
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <Link to="blog-single.html" className="block-20" style={{backgroundImage: "url('assets/images/image_6.jpg')"}}>
		              </Link>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><Link to="#">April 9, 2019</Link></div>
          ...
          <div className="col-lg-4 sidebar ">
            ...
            <div className="sidebar-box ">
              ...
              <ul className="categories">
                <li><Link to="#">Shoes <span>(12)</span></Link></li>
                <li><Link to="#">Men's Shoes <span>(22)</span></Link></li>
                <li><Link to="#">Women's <span>(37)</span></Link></li>
                <li><Link to="#">Accessories <span>(42)</span></Link></li>
                <li><Link to="#">Sports <span>(14)</span></Link></li>
                <li><Link to="#">Lifestyle <span>(140)</span></Link></li>
              </ul>
            </div>
            ...
            <div className="sidebar-box ">
              ...
              <div className="block-21 mb-4 d-flex">
                ...
                <div className="text">
                  ...
                  <div className="meta">
                    <div><Link to="#"><span className="icon-calendar"></span> April 27, 2019</Link></div>
