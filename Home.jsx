...
export default function Home() {
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="assets/images/bg_1.png" class="d-block w-100" alt="..."height="500px" width="50%"/>
    ...
    <div class="carousel-item" data-bs-interval="2000">
      <img src="assets/images/a1.jpg" class="d-block w-100" alt="..."height="600px" width="50%"/>
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="assets/images/a2.jpg" class="d-block w-100" alt="..."height="600px" width="50%"/>
      <div class="carousel-caption d-none d-md-block">
    ...
    <section class="ftco-section ftco-choose ftco-no-pb ftco-no-pt">
    	<div class="container">
				<div class="row no-gutters">
					<div class="col-lg-4">
						<div class="choose-wrap divider-one img p-5 d-flex align-items-end" style={{backgroundImage: "url(assets/images/choose-1.jpg)"}}>
    				...
    				<div class="row no-gutters choose-wrap divider-two align-items-stretch">
    					<div class="col-md-12">
	    					<div class="choose-wrap full-wrap img align-self-stretch d-flex align-item-center justify-content-end" style={{backgroundImage: "url(assets/images/choose-3.jpg)"}}>
    					...
    					<div class="col-md-12">
    						<div class="row no-gutters">
	    						...
	    						<div class="col-md-6">
		    						<div class="choose-wrap wrap img align-self-stretch d-flex align-items-center" style={{backgroundImage: "url(assets/images/choose-3.jpg)"}}>
    				...
    				<div id="timer" class="d-flex mb-4">
						...
						<div class="text-deal">
							...
							<ul class="thumb-deal d-flex mt-4">
								<li class="img" style={{backgroundImage: "url(assets/images/product-6.png)"}}></li>
								<li class="img" style={{backgroundImage: "url(assets/images/product-2.png)"}}></li>
								<li class="img" style={{backgroundImage: "url(assets/images/product-4.png)"}}></li>
							</ul>
						</div>
    			</div>
    		</div>
    ...
    <section class="ftco-section testimony-section">
      <div class="container">
        		...
        		<div class="services-flow row">
        			<div class="services-2 p-4 d-flex col-lg-3 col-md-6 col-12 ">
        				<div class="icon">
        					<span class="flaticon-bag"></span>
        				</div>
        				<div class="text">
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap">
                  <div class="user-img mb-4" style={{backgroundImage: "url(assets/images/person_1.jpg)"}}>
              ...
              <div class="item">
                <div class="testimony-wrap">
                  <div class="user-img mb-4" style={{backgroundImage: "url(assets/images/person_2.jpg)"}}>
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap">
                  <div class="user-img mb-4" style={{backgroundImage: "url(assets/images/person_3.jpg)"}}>
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
